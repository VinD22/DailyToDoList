...
public class DailyToDoListApplication extends Application {
...
//                .build();
        ...
        final RealmConfiguration configuration = new RealmConfiguration.Builder().name("todolist_database.realm").schemaVersion(0).build();
